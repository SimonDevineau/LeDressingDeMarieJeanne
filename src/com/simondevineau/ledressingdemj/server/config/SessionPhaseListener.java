package com.simondevineau.ledressingdemj.server.config;
 ...
 * 
 * <p>
 * If properly configured, an application deployed on the <a
 * href="http://developers.google.com/appengine">Google App Engine<a> platform
 * can leverage HttpSessions to store data between requests. Session data is
 * stored in the datastore and memcache is also used for speed. Session data is
 * persisted at the <strong>end</strong> of the request.
 * </p>
 * <p>
 ...
 *      Java_appengine_web_xml_Enabling_sessions
 * @see http
 *      ://stackoverflow.com/questions/19259457/session-lost-in-google-app-engine
 *      -using-jsf
 */
