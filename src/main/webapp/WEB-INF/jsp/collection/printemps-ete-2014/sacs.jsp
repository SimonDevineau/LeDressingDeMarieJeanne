	...
	<div class="container bs-doc-container">
		<div class="row">
			...
			<div class="col-sm-10 col-md-10">
				<div class="row" id="sacs-container">
					<h1 class="page-header" id="sacs.html">Sacs</h1>
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							<img src="../../img/vetements/printempsete2014/226.jpg" />
							<div class="caption">
								<h4 class="pull-right">30€</h4>
								<h4 class="brand-cloth">Vimoda</h4>
								<p class="cloth-description">Sac Besace</p>
								<h5 class="color-cloth">
									Orange<span class="pull-right size-cloth">Unique</span>
								</h5>
							</div>
						</div>
					</div>
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							<img src="../../img/vetements/printempsete2014/227.jpg" />
							<div class="caption">
								<h4 class="pull-right">20€</h4>
								<h4 class="brand-cloth">Hexagona</h4>
								<p class="cloth-description">Pochette intérieur et extérieur</p>
								<h5 class="color-cloth">
									Noir<span class="pull-right size-cloth">Unique</span>
								</h5>
							</div>
						</div>
					</div>
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							<img src="../../img/vetements/printempsete2014/228.jpg" />
							<div class="caption">
								<h4 class="pull-right">35€</h4>
								<h4 class="brand-cloth">Dandier</h4>
								<p class="cloth-description">Anses tressées</p>
								<h5 class="color-cloth">
									Blanc<span class="pull-right size-cloth">Unique</span>
								</h5>
							</div>
						</div>
					</div>
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							<img src="../../img/vetements/printempsete2014/229.jpg" />
							<div class="caption">
								<h4 class="pull-right">80€</h4>
								<h4 class="brand-cloth">Elena Miro</h4>
								<p class="cloth-description">Imitation serpent</p>
								<h5 class="color-cloth">
									Noir et Serpent<span class="pull-right size-cloth">Unique</span>
								</h5>
							</div>
						</div>
					</div>
